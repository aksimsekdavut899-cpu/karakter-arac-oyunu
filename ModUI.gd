...
func _ready() -> void:
	...
	panel_style.border_color = Color(0.75, 0.75, 0.8)
	...
	capsule.height = 2.0
	capsule.radius = 0.4
	preview_character.mesh = capsule
	...
	preview_character.position = Vector3(0, 1.0, 0)
...
func _show_character_preview() -> void:
	...
	preview_camera.position = Vector3(0, 1.2, 4)
